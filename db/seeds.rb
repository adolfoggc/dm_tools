...
monster_data = {
  ...
  4 => {name: 'giant_rat', challange_rating: "1/8",  ac: 10,  hp: '2d6',  size: "small", speed: 30, abilities: '071511021004'}
}
...
weapon_proprieties_data = {
  ...
  10 => {weapon: Weapon.find_by(name: 'handaxe'), propriety: Propriety.find_by(name: 'throw') },
